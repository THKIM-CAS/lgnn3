...
- `multiplexed2` uses fixed hard binary class codes and lets `--code-gate-fraction` of each shared layer's gates select between two data-data truth tables using one class-code bit. The default is `0.5`.
